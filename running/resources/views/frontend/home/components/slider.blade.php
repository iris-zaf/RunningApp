                        ...
                        <div class="row">
                            <div class="col-xl-5 col-md-5 col-lg-5">
                                <div class="fp__banner_img wow fadeInLeft" data-wow-duration="1s">
                                    <div class="img">
                                        <img src="{{ asset('frontend/images/runshoes.jpg') }}" alt="shoes"
                            ...
                            <div class="col-xl-5 col-md-7 col-lg-6">
                                <div class="fp__banner_text wow fadeInRight" data-wow-duration="1s">
                                    <h1>Running Tips & Ideas</h1>
                                    <h3>Learn from top awarded coaches</h3>
                                    ...
                                    <ul class="d-flex flex-wrap">
                                        <li><a class="common_btn" href="#">Click now</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class=" container">
                        <div class="row">
                            <div class="col-xl-5 col-md-5 col-lg-5">
                                <div class="fp__banner_img wow fadeInLeft" data-wow-duration="1s">
                                    <div class="img">
                                        <img src="frontend/images/eathealthy.avif" alt="food item"
                                            class="img-fluid w-100">
                    ...
                    <div class=" container">
                        <div class="row">
                            <div class="col-xl-5 col-md-5 col-lg-5">
                                <div class="fp__banner_img wow fadeInLeft" data-wow-duration="1s">
                                    <div class="img">
                                        <img src="frontend/images/frontpage.jpg" alt="food item"
                                            class="img-fluid w-100">
                            ...
                            <div class="col-xl-5 col-md-7 col-lg-6">
                                <div class="fp__banner_text wow fadeInRight" data-wow-duration="1s">
                                    <h1>Connect & Run Together</h1>
                                    <h3>Find out runnng teams near your area</h3>
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum fugit minima
                                        et debitis ut distinctio optio qui voluptate natus.</p>
                                    <ul class="d-flex flex-wrap">
                                        <li><a class="common_btn" href="#">Click now</a></li>
